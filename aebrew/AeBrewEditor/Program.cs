...
namespace AeBrewEditor
{
    class Program
    {
        public const string Name = "AeBrew";
        public const string Repository = "T0chi/AeBrew";
        public static Version Version => Assembly.GetExecutingAssembly().GetName().Version;
        public static string FullName => $"{Name} {Version} ({Repository})";
        public static string DiscordUrl = $"https://discord.gg/QZjD3yb";
