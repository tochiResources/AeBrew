...
namespace AeBrewEditor
{
    ...
    {
        private static readonly string mainExecutablePath = "AeBrew.exe";
        private static readonly string[] ignoredPaths = { };

        public static void Build()
        {
            var archiveName = $"AeBrew.{Program.Version.Major}.{Program.Version.Minor}.zip";
        ...
        private static void buildReleaseZip(string archiveName, string appDirectory)
        {
            ...
            using (var archive = new ZipArchive(stream, ZipArchiveMode.Create))
            {
                ...
                addFile(archive, "AeBrewEditor.exe.config", appDirectory);
        ...
        private static void testUpdate(string archiveName)
        {
            ...
            var previousArchiveName = $"AeBrew.{previousVersion}.zip";
