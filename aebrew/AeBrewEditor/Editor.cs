...
using AeBrewEditor.ScreenLayers;
using System;
...
namespace AeBrewEditor
{
    public class Editor : IDisposable
    {
        ...
        {
            ResourceContainer = new AssemblyResourceContainer(Assembly.GetEntryAssembly(), $"{nameof(AeBrewEditor)}.Resources", "resources");
            ...
            try
            {
                ...
                Skin = new Skin(drawContext.Get<TextureContainer>())
                {
                    ...
                    ResolveWidgetType = (widgetTypeName) =>
                        Type.GetType($"{nameof(AeBrewEditor)}.{nameof(UserInterface)}.{widgetTypeName}", false, true) ??
                        brewLibAssembly.GetType($"{nameof(BrewLib)}.{nameof(UserInterface)}.{widgetTypeName}", true, true),
                    ResolveStyleType = (styleTypeName) =>
                        Type.GetType($"{nameof(AeBrewEditor)}.{nameof(UserInterface)}.{nameof(UserInterface.Skinning)}.{nameof(UserInterface.Skinning.Styles)}.{styleTypeName}", false, true) ??
