...
namespace AeBrewEditor.Storyboarding
{
    public class Project : IDisposable
    {
        ...
        public Project(string projectPath, bool withCommonScripts, ResourceContainer resourceContainer)
        {
            ...
            scriptManager = new ScriptManager<StoryboardObjectGenerator>(resourceContainer, "AeBrewScripts", ScriptsPath, CommonScriptsPath, ScriptsLibraryPath, compiledScriptsPath, ReferencedAssemblies);
